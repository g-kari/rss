...
const LAYOUT_LABELS: Record<Layout, string> = { compact: 'コンパクト', list: 'リスト', card: 'カード', magazine: 'マガジン' };
const DATE_RANGE_CYCLE: DateRange[] = ['all', 'today', 'week', 'month'];
const DATE_RANGE_LABELS: Record<DateRange, string> = { all: '全期間', today: '今日', week: '今週', month: '今月' };
