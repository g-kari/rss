...
export default function OfflineBanner({ isOnline, hasPendingChanges }: Props) {
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-atomic="true"
      className="fixed top-0 inset-x-0 z-50 flex items-center justify-center gap-2 py-1.5 bg-surface-subtle border-b border-border-default text-[11px] tracking-[0.04em] text-text-muted"
    >
      <svg
        width="12"
        height="12"
