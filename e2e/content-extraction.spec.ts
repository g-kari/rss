...
test.describe("isTooSmallByUrl — URL サフィックスによるサイズ判定", () => {
  ...
  test("170x170 以上は false を返す", () => {
    expect(isTooSmallByUrl("https://example.com/img-100x100.jpg")).toBe(true);
    expect(isTooSmallByUrl("https://example.com/img-160x160.jpg")).toBe(true);
    expect(isTooSmallByUrl("https://example.com/img-170x170.jpg")).toBe(false);
