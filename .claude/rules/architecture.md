...
| **プラットフォーム / 基盤** | storage / dev-log / serialize / concurrency / type guards / 位置計算        | `storage.ts` / `dev-log.ts` / `serialize-error.ts` / `serialize-async.ts` / `concurrency.ts` / `type-guards.ts` / `modal-focus.ts` / `menu-class.ts` / `context-menu-position.ts` / `selection-popup-position.ts` / `popup-lock.ts`                                                                                                                                                                                                                                                                                                                  |
